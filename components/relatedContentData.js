const tools = {
  ...
  thumbnail: ['Thumbnail Text Checker', '/tools/thumbnail-text-checker', 'Check whether thumbnail or cover text is short and easy to scan.'],
...
const toolMap = {
  ...
  'Thumbnail Text Checker': [['title', 'hook', 'publishing', 'caption'], ['preRecord', 'facelessVideo', 'workflow']],
